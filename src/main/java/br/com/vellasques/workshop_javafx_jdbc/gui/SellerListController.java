package br.com.vellasques.workshop_javafx_jdbc.gui;

import br.com.vellasques.workshop_javafx_jdbc.Main;
import br.com.vellasques.workshop_javafx_jdbc.db.DbIntegrityException;
import br.com.vellasques.workshop_javafx_jdbc.gui.listeners.DataChangeListener;
import br.com.vellasques.workshop_javafx_jdbc.gui.util.Alerts;
import br.com.vellasques.workshop_javafx_jdbc.gui.util.Utils;
import br.com.vellasques.workshop_javafx_jdbc.model.entities.Seller;
import br.com.vellasques.workshop_javafx_jdbc.model.services.DepartmentService;
import br.com.vellasques.workshop_javafx_jdbc.model.services.SellerService;
...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.setServices(new SellerService(), new DepartmentService()); // injetar a dependencia do SellerService (que tem o acesso ao BD, na classe controller)
