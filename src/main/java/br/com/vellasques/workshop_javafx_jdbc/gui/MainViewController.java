...
import br.com.vellasques.workshop_javafx_jdbc.HelloApplication;
...
public class MainViewController implements Initializable {
	...
	private void onMenuItemAboutAction() {
		loadView("About.fxml", x -> {}); // x leva em nada, informo pq é obrigatório informar sempre vazio ou preenchido
	}
...
//			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(absoluteName));
			...
			T controller = fxmlLoader.getController(); // Retorna controle T
